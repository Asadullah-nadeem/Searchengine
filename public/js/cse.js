...
(function (opts_) {
  ...
  */
    ...
    function n(a) {
        return a instanceof k && a.constructor === k && a.g === m
            ? a.h
            : "type_error:Const";
    }
    var m = {},
    ...
    function r(a) {
        return a instanceof p && a.constructor === p
            ? a.h
...
*/
    ...
    function O(a) {
        ...
        a: {
            if (a instanceof p) b.href = r(a).toString();
                ...
                if (a instanceof E)
                    a =
                        a instanceof E && a.constructor === E ? a.g : "type_error:SafeUrl";
                else {
                    c: if (H) {
                        try {
                            var c = new URL(a);
    ...
    var T,
        ...
        W =
            null ==
            (V = (U = ((S.ownerDocument && S.ownerDocument.defaultView) || window)
                .document).querySelector)
                ? void 0
                : V.call(U, "script[nonce]");
    (T = W ? W.nonce || W.getAttribute("nonce") || "" : "") &&
    S.setAttribute("nonce", T);
                ...
                O(
                    opts_.cselibVersion
                        ? u(K, {
                            ...
                            versionSlash: L,
                            experiment:
                                opts_.uiOptions.cssThemeVersion &&
                                4 !== opts_.uiOptions.cssThemeVersion
    ...
    "cx": "348f924e9364445d1",
    "language": "en",
    "theme": "V2_DEFAULT",
    "uiOptions": {
        "resultsUrl": "http://localhost:3000/custom-search-results?cx=348f924e9364445d1",
    ...
    cse_token: "AB-tC_4G1AwTdzHLGK35rZCear0s:1731258039130",
    isHostedPage: false,
    exp: ["cc", "apo"],
